...
This document outlines the test cases for verifying the core features of the AVG Engine, including the newly implemented System Settings, Save/Load system, and Auto-Play functionality.
